...
export const SignTransactionSchema = Type.Object({
    ...
    paymentRequests: Type.Optional(Type.Array(PROTO.PaymentRequest)),
...
export const paramDescriptions = {
    ...
    paymentRequests:
        'of [PROTO.PaymentRequest](https://github.com/trezor/trezor-suite/blob/develop/packages/protobuf/src/definitions/messages-bitcoin.ts). See [SLIP-24](https://github.com/satoshilabs/slips/blob/slip24/slip-0024.md)',
    refTxs:
        ...
        '> Zcash refTxs should also contains `expiry`, `version_group_id` and `extra_data` fields.',
    locktime: '',
    version: 'transaction version,',
    expiry: 'only for Zcash,',
